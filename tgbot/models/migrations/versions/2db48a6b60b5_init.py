...
Revision ID: 2db48a6b60b5
Revises: 
Create Date: 2022-06-16 14:34:32.444586
...
def upgrade():
    ...
    op.drop_table('registration_region')
    ...
    op.alter_column('registration_application', 'created_at',
               existing_type=postgresql.TIMESTAMP(timezone=True),
               nullable=True)
    op.alter_column('registration_application', 'updated_at',
               existing_type=postgresql.TIMESTAMP(timezone=True),
               nullable=True)
...
def downgrade():
    ...
    op.create_table('registration_region',
    sa.Column('id', sa.BIGINT(), autoincrement=True, nullable=False),
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=False),
    sa.Column('region_name', sa.VARCHAR(length=75), autoincrement=False, nullable=False),
    sa.PrimaryKeyConstraint('id', name='registration_regions_pkey')
    )
